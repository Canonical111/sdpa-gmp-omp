...
mpf_class Jal::getMinEigen(DenseLinearSpace &lMat, DenseLinearSpace &xMat, WorkVariables &work) {
...
mpf_class Jal::getMinEigen(DenseLinearSpace &xMat, WorkVariables &work) {
    mpf_class min = 1.0E50;
    mpf_class value;
...
bool Jal::multiply(DenseLinearSpace &retMat, DenseLinearSpace &aMat, DenseLinearSpace &bMat, mpf_class *scalar) {
